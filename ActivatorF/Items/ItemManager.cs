...
namespace ActivatorF.Items
{
    internal static class ItemManager
    {
        ...
        public static void Init()
        {
            ...
            PotionsMenu.Add("healthPotionManagerMinMeHP", new Slider("Min HP %", 65));
            PotionsMenu.AddSeparator();
            PotionsMenu.Add("biscuitPotionManager", new CheckBox("Biscuit"));
            PotionsMenu.Add("biscuitPotionManagerMinMeHP", new Slider("Min HP %", 65));
            PotionsMenu.AddSeparator();
            PotionsMenu.Add("corruptpotManager", new CheckBox("Corrupt Potion"));
            PotionsMenu.Add("corruptpotManagerMinMeHP", new Slider("Min HP %", 60));
            PotionsMenu.Add("corruptpotManagerMinMeMana", new Slider("Min Mana %", 30));
            PotionsMenu.AddSeparator();
            PotionsMenu.Add("huntersPotManager", new CheckBox("Hunter's Potion"));
            PotionsMenu.Add("huntersPotManagerMinMeHP", new Slider("Min HP %", 60));
            PotionsMenu.Add("huntersPotManagerMinMeMana", new Slider("Min Mana %", 30));
